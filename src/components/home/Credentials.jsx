      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="lg:col-span-2 p-8 rounded-2xl bg-[#0d0d0d] border border-white/5"
          >
            ...
            <p className="text-[#999] text-sm leading-relaxed mb-4">
              <span className="text-white font-medium">Seed → IPO operating exposure.</span> I've launched products 
              at pre-revenue startups, through Series B scale-ups (Prospection — US market entry), to publicly 
              listed global brands (Procore IPO, Equifax, IDEXX Laboratories). I've operated with multi-million 
              dollar budgets and near-zero budgets.
            </p>
          ...
          <motion.div
            ...
            className="p-8 rounded-2xl border border-[#E91E8C]/20 bg-gradient-to-b from-[#E91E8C]/5 to-transparent"
          >
            <p className="text-xs font-semibold uppercase tracking-widest text-[#E91E8C] mb-4">
              Recent Work
            </p>
