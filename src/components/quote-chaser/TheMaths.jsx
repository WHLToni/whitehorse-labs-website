    ...
    <section className="py-16 md:py-20 bg-white">
      ...
      >
        ...
        <p className="text-base md:text-lg text-[#444] leading-relaxed">
          What's your average job worth? If it's $1,500 or more, one recovered job pays for months of
          Quote Chaser. Most clients only need us to win back one job a quarter to come out ahead —
          the rest is profit you were previously donating to your competitors.
        </p>
      </motion.div>
    </section>
  );
