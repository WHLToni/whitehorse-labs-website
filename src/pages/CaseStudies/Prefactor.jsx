          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-16">
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl leading-snug text-[#0a0a0a]">
                Over $1M raised. 45 Free users. Zero conversions. Three months out from a US launch.
              </h2>
            </motion.div>
            ...
            >
              <p>When Prefactor approached me to build the foundations for a US market entry, the brief was lean: positioning and messaging frameworks, a fresh pitch deck, and a white paper. Goals: Secure at least 25 meetings in the US (ideally locked in before departure), and present credibly in Silicone Valley boardrooms.</p>
      ...
      <section className="bg-white">
        <div className="max-w-[900px] mx-auto px-10 pt-4 pb-20">
          ...
          <div className="flex flex-col gap-10">
            {[
              { num: "01", title: "They were targeting the wrong buyer.", body: "Engineers were an engaged beta user group, but they were never going to buy. They don't control budgets. Enterprise purchasing decisions rest with the CTO, CISO, or CPO. Prefactor needed a completely different language for this completely different buyer." },
              { num: "02", title: "The product wasn't solving a real problem.", body: "Prefactor was building a technically sound product, but it wasn't solving a burning problem. They'd built the wrong tool. Senior execs were concerned about auditability, visibility, control and demonstrable ROI from their agentic AI investments, not MCP authentication." },
