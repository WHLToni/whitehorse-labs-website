    ...
    <div>
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 bg-[#0a0a0a]">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-10 left-1/2 w-[600px] h-[400px] rounded-full bg-[#e8195a]/8 blur-[150px]" />
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-3 mb-8">
              {problemQuestions.map((q, i) => (
                <div key={i} className="text-[#555] text-sm pl-4 border-l-2 border-[#e8195a]/30">{q}</div>
              ))}
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-lg bg-[#e8195a]/10 flex items-center justify-center flex-shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              {["The same systems I use with clients", "Templates, frameworks, checklists, guides", "Years of trial-and-error condensed into proven processes"].map((item, i) => (
                <div key={i} className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-[#e8195a] flex-shrink-0 mt-0.5" />
                  <span className="text-[#555] text-sm">{item}</span>
                </div>
              ))}
            </div>
