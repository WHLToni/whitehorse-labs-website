    ...
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl">
            ...
            <button className="btn-gradient inline-flex items-center gap-2 text-white font-semibold px-8 py-4 rounded-lg text-base">
              <ShoppingCart className="w-5 h-5" />Buy Now — $149
            </button>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6 text-[#0a0a0a]">You've built an MVP. Now what?</h2>
            <p className="text-[#666] text-sm leading-relaxed mb-6">You've built an MVP. It works. You've shown it to a few people and they like it. Now you're stuck:</p>
            <div className="space-y-3 mb-8">
              {["Who is this for?", "How do I position it against competitors?", "What's my GTM strategy?", "How do I price it?", "What do I say in my pitch deck?"].map((q, i) => (
                <div key={i} className="text-[#555] text-sm pl-4 border-l-2 border-[#E91E8C]/30">{q}</div>
              ))}
            </div>
            <p className="text-[#666] text-sm leading-relaxed">
              You could wing it and burn cash figuring it out. You could hire a consultant if you had $15K. Or you could try ChatGPT and get generic advice with no structure.
              The Launch System gives you structure — the same frameworks I've used to launch 20+ products over 20 years.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-[#f7f7f8]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-16 text-[#0a0a0a]">Two Complete Portals</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              className="p-8 md:p-10 rounded-2xl bg-white border border-[#e5e5e5]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-[#0a0a0a]">Portal 1: GTM Foundations</h3>
              </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-[#0a0a0a]">Portal 2: Vibe Coding System</h3>
              </div>
              <div className="space-y-3">
                {portal2.map((item, i) => (
                  <div key={i} className="flex items-start gap-3">
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#E91E8C] mb-4">How It Works</p>
              <div className="space-y-4">
                {["Purchase. Instant access to both portals (Notion-based, easy to duplicate).", "Populate the frameworks, fill in the templates, do the research.", "Launch with positioning, messaging, and strategy."].map((step, i) => (
                  <div key={i} className="flex items-start gap-4">
                    <span className="gradient-text-simple text-lg font-bold flex-shrink-0">{String(i + 1).padStart(2, "0")}</span>
                    <p className="text-[#666] text-sm leading-relaxed">{step}</p>
                  </div>
                ))}
              </div>
              <p className="text-[#aaa] text-xs mt-6">If you complete the system and want execution later, upgrade to a productised service and get $149 credit.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-[#f7f7f8]">
        <div className="max-w-3xl mx-auto px-6 lg:px-10">
          ...
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-8 text-[#0a0a0a]">What You're NOT Getting</h2>
          <p className="text-[#666] text-sm mb-6">This is a framework, not a done-for-you service.</p>
          ...
          <p className="text-[#aaa] text-xs mt-6">If you want done-for-you execution:{" "}
      ...
      <section className="py-24 md:py-32 bg-[#0a0a0a]">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
          <div className="gradient-text text-6xl md:text-7xl font-bold mb-4">$149</div>
          <p className="text-[#999] text-base mb-2">One-Time Payment. Lifetime Access.</p>
          <p className="text-[#666] text-sm mb-10">No subscription. No upsells. Pay once, get instant access, use it forever. Lifetime updates included.</p>
      ...
      <section className="py-24 md:py-32 bg-[#f7f7f8]">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
          ...
          <p className="text-[#666] text-base mb-8">Download the free ICP Framework — one of the core tools inside the Launch System.</p>
