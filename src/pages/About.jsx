    ...
    <div>
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="absolute inset-0">
          <div className="absolute top-0 right-1/4 w-[500px] h-[400px] rounded-full bg-[#4BA4D8]/8 blur-[150px]" />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-4 text-[#999] text-sm leading-relaxed">
                <p>
                  I've spent 20+ years launching complex products in environments where you can't 
                  just "move fast and break things" — healthtech, medtech, veterinary tech, fintech, 
                  construction tech, SaaS. Regulated industries where commercialisation requires 
                  compliance fluency, not just speed.
                </p>
                <p>
                  By year two, teams in these industries realise product commercialisation isn't 
                  creative chaos. It needs the same rigour as finance or HR — frameworks, segmentation 
                  models, competitive analysis, positioning architecture, launch systems.
                </p>
                <p>
                  The problem: product management and product marketing are rare skills. Rarer when 
                  combined. Add an MBA, 20 years of pattern recognition across regulated markets, and 
                  two years of AI experimentation — and you've got something that's hard to replicate.
                </p>
                <p className="text-white font-medium">
                  That's what Whitehorse Labs is: the intersection of product, marketing, AI, and 
                  decades of commercial discipline.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-[#999] text-sm leading-relaxed">
                <p className="text-white font-medium">
                  I don't run workshops and hand you a deck. I bring systems.
                </p>
                <p>
                  Over the past two years, I've built AI-accelerated frameworks for every stage 
                  of product commercialisation — market research, segmentation, competitive analysis, 
                  positioning, messaging, brand strategy, launch execution. These aren't theoretical. 
                  They're the same systems I've used to launch products for IDEXX (Innovation Award 
                  for Digital Pathology launch), Equifax (PPSR, Debtor IQ, Alerts across APAC), 
                  and multiple health-tech and SaaS startups.
                </p>
                <p>
                  What used to take three months in a corporate environment now takes weeks because 
                  I've systematised it and use AI to accelerate research, synthesis, and asset creation.
                </p>
                <p className="text-white">
                  You get the impact of a cross-functional team, delivered by one expert, at a 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="p-8 rounded-2xl bg-[#0d0d0d] border border-white/5"
              >
                <h3 className="font-['Space_Grotesk'] text-lg font-semibold mb-2">{item.stage}</h3>
          ...
          <div className="space-y-4">
            {credentials.map((c, i) => (
              ...
              >
                ...
                <p className="text-[#999] text-sm leading-relaxed">{c}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 md:py-32 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#E91E8C] mb-12">
            What Clients Say
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {testimonials.map((t, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="p-8 rounded-2xl bg-[#0d0d0d] border border-white/5 relative"
              >
                <Quote className="w-8 h-8 text-[#E91E8C]/20 mb-4" />
      ...
      <section className="py-24 md:py-32 border-t border-white/5">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
          <h2 className="font-['Space_Grotesk'] text-3xl md:text-4xl font-bold tracking-tight mb-10">
            Let's Work
          </h2>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 text-[#999] hover:text-white text-sm mt-6 transition-colors"
          >
            <Download className="w-4 h-4" />
            Or download the Free ICP Framework
          </Link>
        </div>
      </section>
    </div>
