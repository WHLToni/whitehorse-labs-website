...
export default function Success() {
  ...
  return (
    <div className="ds-page min-h-[80vh] flex items-center justify-center px-6">
      <motion.div
      ...
      >
        <div className="w-16 h-16 rounded-full bg-[#C13B54]/10 flex items-center justify-center mx-auto mb-6">
          <CheckCircle className="w-8 h-8 text-[#C13B54]" />
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-[#E1E7E9]">
          <Link
            to="/"
