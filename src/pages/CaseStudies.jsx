      ...
      <section className="band band--mist hann" id="work">
        <div className="wrap">
          <div className="hann-head reveal">
            ...
            <p className="hann-lead">A young spelling &amp; training business looking to establish a position as a premium vendor in the bloodstock space. They needed to stand out at an annual sale, with a small draft of around 10 horses, and needed to warm buyers up beforehand. I built a full showcase brochure for every horse in the draft, telling the story of each elite athlete: history, health, training, strengths and conformation, pedigree, personality and temperament. These were distributed as a multi-media interactive brochure (including embedded video content) in a pre-sale email campaign. They were produced in gloss print for every stall, along with premium venue signage and sales tools. The result was a premium, distinctive experience at the venue, and buyers who arrived at the stalls with a shortlist before they'd even met a single horse.</p>
            <div className="hann-facts">
              <span>Digital multi-media brochures, for pre-sale email campaign</span>
              <span>Gloss print brochures on every stall, and interactive web catalogue</span>
              <span>Branded signage, note cards &amp; social tiles for the venue</span>
            </div>
          </div>
            ...
            <div className="case-media">
              <div className="combo">
                <div className="device-browser">
                  ...
                  <div className="screen"><img src="https://media.base44.com/images/public/6995347084af76a3154d3f6b/913a969ac_Screenshot2026-07-29at111244pm.png" alt="Stayble website homepage on desktop" /></div>
                </div>
        ...
        <div className="wrap">
          <article className="case reveal">
            <div className="case-head">
              ...
              <p className="case-body">A mature established business with a loyal customer base entirely on paper records — valuable, but completely inaccessible. With a new product line to launch, the owner wanted to make as much impact as possible with limited budget, and digitise / automate wherever possible. Marketing to existing and past customers is far more successful and profitable than marketing only to new prospects. So I moved the most recent 5 years worth of paper-based client records into a marketing automation platform and SMS delivery platform, and kicked off ongoing segmented multi-channel campaigns to this entire warm audience. We've started slowly introducing brand standards (as budget allows) into socials, and footage that will be used across multiple channels. The website brief was clear: no rebuild, so I keep an established site current and working rather than overhauling it.</p>
            </div>
            <div className="case-media">
        ...
        <div className="wrap">
          <article className="case reveal">
            <div className="case-head">
              ...
              <ul className="facts">
                <li>Complete brand strategy and visual identity</li>
                <li>Customer discovery programme and market research</li>
                <li>Segmentation, targeting &amp; positioning frameworks</li>
        ...
        <div className="wrap">
          <article className="case reveal">
            <div className="case-head">
              ...
              <p className="case-body">I build and run the annual multi-channel marketing campaign for this yearly conference, to a very niche, corporate audience. Tickets are around $2000 - last year we sold out, smashing a challenging target. I create the plan, write the copy, produce and distribute the content across key channels. I keep content production efficient and lean - at last year's event, I interviewed and filmed delegates and speakers throughout the day, producing a twelve-part series for social media - to promote this year's conference and seed the European launch early next year.</p>
              <ul className="facts">
