        ...
        <div className="wrap">
          <article className="case reveal">
            <div className="case-head">
              ...
              <p className="case-body">A mature established business with a loyal customer base entirely on paper records — valuable, but completely inaccessible. With a new product line to launch, the owner wanted to make as much impact as possible with limited budget. He also wanted to digitise and automate as much as possible. Marketing to existing and past customers is far more successful and profitable than marketing only to new prospects. So I moved the most recent 5 years worth of paper-based client records into a marketing automation platform and SMS delivery platform, and kicked off ongoing segmented multi-channel campaigns to this warm audience. We've started slowly introducing brand standards (as budget allows) into socials, and footage that will be used across multiple channels. The website brief was clear: no rebuild, so I keep an established site current and working rather than overhauling it.</p>
            </div>
            <div className="case-media">
