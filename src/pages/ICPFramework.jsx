    ...
    <div>
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="absolute inset-0">
          <div className="absolute top-10 right-1/4 w-[500px] h-[400px] rounded-full bg-[#00C4E0]/8 blur-[150px]" />
        </div>
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <p className="text-xs font-semibold uppercase tracking-widest text-[#00C4E0] mb-4">
              Free Resource
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-2xl">
            ...
            <h2 className="font-['Space_Grotesk'] text-3xl md:text-4xl font-bold tracking-tight mb-6">
              Early-stage founders try to sell to everyone.
            </h2>
            <div className="space-y-3 mb-8">
              {[
                '"Our product is for small businesses."',
                '"We\'re targeting millennials."',
                '"Anyone who needs X can use this."',
              ].map((q, i) => (
                <div key={i} className="text-[#666] text-sm italic pl-4 border-l-2 border-white/10">
                  {q}
                </div>
              ))}
            </div>
            <p className="text-white text-sm font-medium mb-4">That's not an ICP. That's a guess.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
            {includes.map((item, i) => (
              <motion.div
                ...
                className="flex items-start gap-3 p-6 rounded-xl bg-[#0d0d0d] border border-white/5"
              >
                <Check className="w-5 h-5 mt-0.5 text-[#E91E8C] flex-shrink-0" />
                <span className="text-[#999] text-sm leading-relaxed">{item}</span>
              </motion.div>
            ))}
          </div>
          <p className="text-[#666] text-xs mt-4">Format: Notion template.</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-[#999] text-sm leading-relaxed">
                This framework is built on 20 years of product and marketing launches across 
                regulated industries. I've used it to define ICPs for healthtech startups 
                entering the US, fintech products targeting SMBs in APAC, SaaS tools for 
                enterprise procurement, and veterinary platforms for multi-location clinics. 
                It's rigorous, structured, repeatable.
              </p>
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#E91E8C] mb-4">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
            {steps.map((s, i) => (
              ...
              >
                <span className="gradient-text-simple font-['Space_Grotesk'] text-2xl font-bold">
                  {s.num}
                </span>
                <h3 className="font-['Space_Grotesk'] text-base font-semibold mt-3 mb-2">{s.title}</h3>
                <p className="text-[#999] text-xs leading-relaxed">{s.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 md:py-32 border-t border-white/5">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
          <h2 className="font-['Space_Grotesk'] text-3xl md:text-4xl font-bold tracking-tight mb-4">
            Ready to Stop Guessing?
          </h2>
          <p className="text-[#999] text-base mb-10">
            Get the ICP Interview Framework and start building your customer profile today.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            <Link
              ...
              className="text-[#999] hover:text-white text-sm transition-colors inline-flex items-center gap-2"
            >
              <ShoppingCart className="w-4 h-4" />
              Or get the full Launch System — $149
            </Link>
            <Link
